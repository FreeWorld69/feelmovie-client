...
export class VideoComponent {
  ...
  movieDetails$: Observable<MovieSchema>;
  @Select(DetailedMovieState.selectVideoSources) videoSources$: Observable<
    Plyr.Source[]
  >;
  public player: Plyr;

  constructor(public tempHelper: Helper) {}
  ...
  ngOnInit() {
    this.videoSources$.subscribe((data) => {
      console.log(data);
    });
  }
}
