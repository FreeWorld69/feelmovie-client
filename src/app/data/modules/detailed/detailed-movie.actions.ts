...
export namespace DetailedMovieActions {
  ...
  export class UpdateSeriesLoading {
    public static readonly type: string = '[Detailed] update series loading';
    constructor(public season: number, public screenLoading: boolean) {}
  }

  export class ToggleAccordion {
    public static readonly type: string = '[Detailed] toggle accordion';
    constructor(public season: number, public opened: boolean) {}
  }
}
